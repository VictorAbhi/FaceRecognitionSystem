...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        std_b1 = Button(bg_img, command=self.atendee_panel, image=self.std_img1, cursor="hand2")
        std_b1.place(x=250, y=100, width=180, height=180)

        std_b1_1 = Button(bg_img, command=self.atendee_panel, text="Attendee Panel", cursor="hand2",
        ...
        tra_b1 = Button(bg_img, command=self.train_panel, image=self.tra_img1, cursor="hand2", )
        tra_b1.place(x=250, y=330, width=180, height=180)

        tra_b1_1 = Button(bg_img, command=self.train_panel, text="Data Train", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
    ...
    def atendee_panel(self):
        self.new_window=Toplevel(self.root)
        self.app=Atendee(self.new_window)
